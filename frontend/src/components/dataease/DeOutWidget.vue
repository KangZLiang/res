<template>
  ...
  >
    ...
    >
      <div
        v-if="element.options.attrs.showTitle && element.options.attrs.title && element.options.attrs.label !== 'carousel'"
      ...
      <div
        ...
        :class="[element.label === '库位'? 'condition-main-height': '' , (element.options.attrs.showTitle && element.options.attrs.title) ? '' : 'condition-content-default']"
      >
        <div class="condition-content-container">
          <div class="first-element">
            <div
              :class="[element.label === '库位'? 'first-element-container-height': '',element.component === 'de-select-grid' ? 'first-element-grid-container': '']"
...
.first-element-container-height {
  height: 100% !important;
}
