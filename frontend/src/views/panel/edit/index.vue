      ...
      <de-main-container id="canvasInfo-main">
        ...
        >
          <div style="width: 295px">
            ...
            <echarts-setting v-show=" show &&showIndex===4"/>
          </div>
        </el-drawer>
        <!--PC端画布区域-->
...
import EchartsSetting from "@/views/panel/echarts-setting/index";
  ...
  computed: {
    ...
    showAttr() {
      if (this.mobileLayoutStatus) {
        ...
        // 过滤组件有标题才显示
        if (this.curComponent.type === 'custom' && (!this.curComponent.options.attrs.showTitle || !this.curComponent.options.attrs.title) && this.curComponent.component !== 'de-carousel') {
          return false
        } else {
          return true
        }
  ...
  methods: {
    ...
    editDialog(editType) {
      ...
      if (this.curComponent && this.curComponent.serviceName) {
        ...
        if(this.curComponent.serviceName != "settingStoreHouse") {
