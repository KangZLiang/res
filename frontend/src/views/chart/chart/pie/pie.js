        ...
        if(isGradient) {
          y.itemStyle = {
            color: {
              ...
              colorStops: [{
                offset: 0,
                color: hexColorToRGBA(customAttr.color.colors[i % customAttr.color.colors.length], customAttr.color.alpha) // 0% 处的颜色
              },
                {
                  offset: 1,
                  color: hexColorToRGBA(customAttr.color.colors[i + 1 % customAttr.color.colors.length], customAttr.color.alpha) // 100% 处的颜色
                }],
