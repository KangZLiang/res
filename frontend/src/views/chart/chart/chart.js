...
export const DEFAULT_COLOR_CASE = {
  ...
  dimensionColorType:false,
  dimensionCustomColor:'#000000',
  quotaColor: '#5470c6',
  quotaColorType: false,
  quotaColorCustomType: '#000000',
  tableBorderColor: '#E6E7E4',
  seriesColors: [], // 格式：{"name":"s1","color":"","isCustom":false,"isSenior":false}
  areaBorderColor: '#303133',
  gradient: false,
  areaBaseColor: '#FFFFFF',
  tableScrollBarColor: 'rgba(0, 0, 0, 0.15)',
  tableScrollBarHoverColor: 'rgba(0, 0, 0, 0.4)',
  tableItemCustomBgColor: '#FFFFFF',
  tableItemCustomFontColor: '#000000',
  tableItemBgColorType: false,
  tableItemFontColorType: false,
  backColor: '#000000',
  backColorType:false,
  backCustomColor:'#000000',
  MaxMinColor: '#8a8a8a',
  MaxMinType:false,
  MaxMinNum:'',
  isGradient: false,
  BorderRadius: 10,
  BorderRadiusType: false,
}
...
export const DEFAULT_COLOR_CASE_DARK = {
  ...
  dimensionColorType:false,
  dimensionCustomColor:'#ffffff',
  quotaColor: '#5470c6',
  quotaColorType: false,
  quotaCustomColor: '#000000',
  ...
  tableItemCustomBgColor: '#131E42',
  tableItemCustomFontColor: '#ffffff',
  tableItemBgColorType: false,
  tableItemFontColorType: false,
  backColor: '#ffffff',
  backColorType:false,
  backCustomColor:'#ffffff',
  MaxMinColor: '#8a8a8a',
  MaxMinType:false,
  MaxMinNum:'',
  isGradient: false,
...
export const DEFAULT_SIZE = {
  ...
  showScroller: true,
  showOperate: false,
  showOperateValue:'127.0.0.1:8081'
}
