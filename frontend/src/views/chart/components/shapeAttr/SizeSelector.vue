  ...
  <div style="width: 100%">
    <el-col>
      ...
      >
        ...
        <el-form-item
          v-show="showProperty('showHeader')"
          label-width="100px"
          :label="$t('chart.show_header')"
          class="form-item"
        >
          <el-checkbox
            v-model="sizeForm.showHeader"
            @change="changeBarSizeCase('showHeader')"
          >{{ $t('chart.show') }}</el-checkbox>
        </el-form-item>
        <el-form-item
          v-show="showProperty('showBorder')"
          label-width="100px"
          :label="$t('chart.show_border')"
          class="form-item"
        >
          <el-checkbox
            v-model="sizeForm.showBorder"
            @change="changeBarSizeCase('showBorder')"
          >{{ $t('chart.show') }}</el-checkbox>
        </el-form-item>
        <el-form-item
          v-show="showProperty('showScroller')"
          label-width="100px"
          :label="$t('chart.show_scroller')"
          class="form-item"
        >
          <el-checkbox
            v-model="sizeForm.showScroller"
            @change="changeBarSizeCase('showScroller')"
          >{{ $t('chart.show') }}</el-checkbox>
        </el-form-item>
        <el-form-item
          v-show="showProperty('showOperate')"
          label-width="100px"
          :label="$t('chart.show_operate')"
          class="form-item"
        >
          <el-checkbox
            v-model="sizeForm.showOperate"
            @change="changeBarSizeCase('showOperate')"
          >{{ $t('chart.show') }}</el-checkbox>
          ...
          <el-input v-show="sizeForm.showOperate" v-model="sizeForm.showOperateValue" placeholder="127.0.0.1:8081" ></el-input>
        </el-form-item>
        <el-form-item
        ...
        <el-form-item v-show="showProperty('headerAlign')" label-width="100px" :label="$t('chart.table_header_align')" class="form-item">
          <el-radio-group v-model="sizeForm.headerAlign" size="mini" @change="changeBarSizeCase('headerAlign')">
        ...
        <el-form-item v-show="showProperty('itemAlign')" label-width="100px" :label="$t('chart.table_item_align')" class="form-item">
          <el-radio-group v-model="sizeForm.itemAlign" size="mini" @change="changeBarSizeCase('itemAlign')">
            <el-radio-button label="left">{{ $t('chart.text_pos_left') }}</el-radio-button>
            <el-radio-button label="center">{{ $t('chart.text_pos_center') }}</el-radio-button>
            <el-radio-button label="right">{{ $t('chart.text_pos_right') }}</el-radio-button>
          </el-radio-group>
        ...
        <el-form-item v-show="showProperty('tableCustomColWidth')" label-width="100px" :label="$t('chart.table_custom_column_width_config')" class="form-item">
          <div style="display: flex;align-items: center">
            <el-tooltip effect="dark" placement="bottom">
              <div slot="content">
                例子：100,100(根据列依次给值，用逗号隔开)
                <br>
                逗号为英文逗号
              </div>
              <i class="el-icon-info" style="cursor: pointer;color: #606266;margin-left: 4px;" />
            </el-tooltip>
            <el-input v-model="sizeForm.tableCustomColWidth"  placeholder="列宽度(英文','分割)" clearable   @change="changeBarSizeCase('tableCustomColWidth')" />
          </div>
        </el-form-item>
        <el-form-item
        ...
        <!--text&label-start-->
        <el-form-item
          v-show="showProperty('quotaShow')"
          :label="$t('chart.quota_show')"
          class="form-item"
        >
          <el-checkbox
            v-model="sizeForm.quotaShow"
            @change="changeBarSizeCase('quotaShow')"
          >{{ $t('chart.show') }}</el-checkbox>
        </el-form-item>
        <el-form-item
...
export default {
  ...
  methods: {
    ...
    changeBarSizeCase(modifyName) {
      if (modifyName == 'tableCustomColWidth'){
        let customW = []
        customW = this.sizeForm.tableCustomColWidth.split(',')
        this.sizeForm.tableCustomColWidth = customW
      }
