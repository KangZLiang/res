    ...
    <el-row class="view-panel-row">
      ...
      >
              ...
              >
                <el-row style="height: 100%;">
                  ...
                  <div v-else>
                    ...
                    <!--xAxis-->
                    <el-row
                      v-if="view.type !=='text' && view.type !== 'gauge' && view.type !== 'liquid' && view.type !== 'battery'"
                      class="padding-lr"
                    >
                      <span class="data-area-label">
                    ...
                    >
                      <span class="data-area-label">
                        ...
                        <span
                          v-else-if="view.type &&( view.type.includes('text') || view.type.includes('battery'))"
                    ...
                    <el-row
                      v-if="view.type && !(view.type.includes('table') && view.render === 'echarts') && !view.type.includes('text') && !view.type.includes('battery') && !view.type.includes('gauge') && view.type !== 'liquid' && view.type !== 'word-cloud' && view.type !== 'table-pivot' && view.type !=='label'&&view.type !=='richTextView'"
                      class="padding-lr"
                      style="margin-top: 6px;"
                    >
                      <span style="width: 80px;text-align: right;">
        ...
        >
          <el-row class="view-panel">
            <div
              v-if="view.type && (view.type.includes('bar') || view.type.includes('line') || view.type.includes('area') || view.type.includes('mix') || view.type.includes('gauge') || view.type === 'text' || view.type === 'battery' || view.type === 'label' || view.type.includes('table') || view.type === 'map' || view.type === 'buddle-map')"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <el-collapse-item
                    v-if="view.type && (view.type.includes('gauge') || view.type === 'text' || view.type === 'battery' || view.type === 'label' || (view.render === 'antv' && view.type.includes('table')))"
                    name="threshold"
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <chart-component
              v-else-if="httpRequest.status && chart.type && !chart.type.includes('table') && !chart.type.includes('text') && !chart.type.includes('battery') && chart.type !== 'label' && renderComponent() === 'echarts'"
              ref="dynamicChart"
              :chart-id="chart.id"
              :chart="chart"
              class="chart-class"
            ...
            />
            <chart-component-g2
              v-else-if="httpRequest.status && chart.type && !chart.type.includes('table') && !chart.type.includes('text') && !chart.type.includes('battery') && chart.type !== 'label' && renderComponent() === 'antv'"
              ref="dynamicChart"
              :chart-id="chart.id"
              :chart="chart"
              class="chart-class"
            ...
            />
            <label-normal
              v-else-if="httpRequest.status && chart.type && (chart.type.includes('text') || chart.type.includes('battery'))"
              :chart="chart"
              class="table-class"
            />
            <label-normal-text
...
export default {
  ...
  methods: {
    ...
    defaultData() {
      if (this.view.xaxis.length == 0 &&
        this.view.xaxisExt.length == 0 &&
        this.view.yaxis.length == 0 &&
        this.view.yaxisExt.length == 0 &&
        this.view.extStack.length == 0 &&
        this.view.extBubble.length == 0
      ) {
        this.defaultXaxis = false
        this.view.xaxis.push(this.dimensionData[0])
        this.view.yaxis.push(this.quotaData[0])
        this.calcData(true)
        this.defaultYaxis = false
      }
    },
