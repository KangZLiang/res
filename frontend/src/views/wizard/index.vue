        ...
        <el-row class="content_bottom">
          <div class="content_bottom_contact">
            ...
            <el-row class="contact_content">
              <span>{{ $t('wizard.email') }}service@makerwit.com</span>
            </el-row>
            <el-row class="contact_content">
              <span>①{{ $t('wizard.tel') }}18666919237</span>
            </el-row>
            <el-row class="contact_content">
              <span>②{{ $t('wizard.tel') }}13823665398</span>
            </el-row>
            <el-row class="contact_content">
              {{ $t('wizard.web') }}<a style="text-decoration:underline;" target="_blank"
                                       href="http://www.makerwit.com">www.makerwit.com</a>
            </el-row>
          </div>
          ...
          <div class="content_bottom_qr_code">
            ...
            <div class="contact_wechat_group">
              <div class="contact_title_qr">{{ $t('wizard.company') }}</div>
            </div>
            <div class="contact_wechat_official">
              <div class="contact_title_qr">{{ $t('wizard.address') }}</div>
            </div>
          </div>
        </el-row>
...
import KanbanThumbnail from '@/views/wizard/KanbanThumbnail'
