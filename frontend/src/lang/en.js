export default {
  ...
  chart: {
    ...
    show_scroller: 'Show Scroller',
    show_operate: 'Show Operate',
    ...
    table_custom_column_width_config:'Custom Column Width',
  ...
  dataset: {
    ...
    excel_info_1: '1、Column merge cells cannot exist in the Excel file；',
  ...
  panel: {
    ...
    market_network_tips: 'Server connectivity is required to view the template market template, please check the network... ',
    ...
    export_to_sample: 'Export to Sample',
  ...
  wizard: {
    welcome_title: 'Welcome Use Makerwit-Report',
    welcome_hint: 'Drag and drop visual analysis tool',
    demo_video: 'Demo',
    quick_start: 'Click Set',
    online_document: 'Drag operation',
    latest_developments: 'Latest',
    teaching_video: 'Teaching',
    enterprise_edition: 'Multiple data sources',
    contact_us: 'Contact Us',
    demo_video_hint: 'Click to set the style and simply set it to obtain an exquisite data map',
    online_document_hint: 'Drag and drop the mouse to quickly design a nice big screen data board, and what you see is what you get',
    teaching_video_bottom_hint: 'More videos',
    enterprise_edition_hint1: 'Support multiple common databases',
    enterprise_edition_hint2: 'Support multiple big data databases',
    enterprise_edition_hint3: 'Support interface data source',
    ...
    tel: 'Tel:',
    web: 'Web:',
    company: 'Company: Zhuhai Chuangzhi Technology Co., Ltd',
    address: 'Address: Building 8, Zhengbang Logistics Park, No. 10, Mingfeng Fourth Road, Xiangzhou District, Zhuhai, Guangdong',
