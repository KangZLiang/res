export default {
  ...
  chart: {
    ...
    table_custom_column_width_config:'自定义列宽',
  ...
  dataset: {
    ...
    excel_info_1: '1、Excel 文件中不能存在列合并单元格；',
  ...
  wizard: {
    welcome_title: '欢迎使用Makerwit-Report',
    welcome_hint: '拖拽式的可视化分析工具',
    demo_video: '演示视频',
    quick_start: '点击设置',
    online_document: '拖拽操作',
    latest_developments: '最新动态',
    teaching_video: '教学视频',
    enterprise_edition: '多数据源',
    contact_us: '联系我们',
    demo_video_hint: '点击设置样式，简单设置即可获取精美绝伦的数据图',
    online_document_hint: '鼠标拖拽快速设计好看的大屏数据看板，所见即所得',
    teaching_video_bottom_hint: '更多视频资料',
    enterprise_edition_hint1: '支持多种常用数据库',
    enterprise_edition_hint2: '支持多种大数据数据库',
    enterprise_edition_hint3: '支持接口数据源',
    ...
    tel: '电话：',
    web: '网址：',
    company: '公司：珠海创智科技有限公司',
    address: '地址：广东省珠海市香洲区明丰四路10号正邦物流园园区8号楼',
    apply: '免费试用申请',
    more: '更多',
