export default {
  ...
  chart: {
    ...
    table_custom_column_width_config:'自定義列寬',
  ...
  dataset: {
    ...
    parse_error: 'Excel解析失敗，請檢查格式、字段等信息。',
    ...
    excel_info_1: '1、Excel 文件中不能存在列合併單元格；',
  ...
  panel: {
    ...
    market_network_tips: '查看模板市场模板需要服务器连通，请检查网络...',
  ...
  wizard: {
    welcome_title: '歡迎使用Makerwit-Report',
    welcome_hint: '拖拽式的可視化分析工具',
    demo_video: '演示視頻',
    quick_start: '點擊設置',
    online_document: '拖拽操作',
    latest_developments: '最新動態',
    teaching_video: '教學視頻',
    enterprise_edition: '多數據源',
    contact_us: '聯繫我們',
    demo_video_hint: '點擊設置樣式，簡單設置即可獲取精美絕倫的數據圖',
    online_document_hint: '鼠標拖拽快速設計好看的大屏數據看板，所見即所得',
    teaching_video_bottom_hint: '更多視頻資料',
    enterprise_edition_hint1: '支持多種常用數據庫',
    enterprise_edition_hint2: '支持多種大數據數據庫',
    enterprise_edition_hint3: '支持接口數據源',
    ...
    tel: '電話：',
    web: '網址：',
    company: '公司：珠海創智科技有限公司',
    address: '地址：廣東省珠海市香洲區明豐四路10號正邦物流園園區8號樓',
    apply: '免費試用申請',
    more: '更多',
