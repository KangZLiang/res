...
export function updateTableData(data) {
  return request({
    url: '/dataset/table/makerwit/updateTableData',
    method: 'post',
    loading: true,
    data
  })
...
export function addTableData(data) {
  return request({
    url: '/dataset/table/makerwit/addTableData',
    method: 'post',
    loading: true,
    data
  })
...
export function deleteTableData(data) {
  return request({
    url: '/dataset/table/makerwit/deleteTableData',
    method: 'post',
    loading: true,
    data
  })
...
export function selectTableDate(data) {
  return request({
    url: '/dataset/table/makerwit/selectTableDate',
    method: 'post',
    loading: true,
    data
  })
